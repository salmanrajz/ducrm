...
class MissionDU extends Command
{
    ...
    public function handle()
    {
        ...
        //     echo $i . '<br>';
        //     if($i == 0){
        //         echo $url = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission/BGT.000';
        //         MissionDuFile::create([
        //             'filename' => $url,
        //         ]);
        //     }
        //     else if($i == 1){
        //         $url = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission/BGT.001';
        //         MissionDuFile::create([
        //             'filename' => $url,
        //         ]);
        //     }
        ...
        //     }
        //     else{
        //         $url = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission/BGT.' . $i;
        //         MissionDuFile::create([
        //             'filename' => $url,
        //         ]);
        //     }
...
if ($m) {
    $link = $m->filename;
    // $link = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission/BGT.013';
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://138.91.156.179:3000/allNumber',
