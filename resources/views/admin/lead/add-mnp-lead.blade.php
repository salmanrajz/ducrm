                        ...
                        <div class="row">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select name="additional_docs_name" id="additional_docs_name" class="form-control" required>
                                            ...
                                            <option value="Salary Certificate">Salary Certificate (latest 3 months (min. salary of AED 2,500 with UAE based company name. Contact details, original company stamp on letterhead is required))</option>
                                            <option value="Utility Bill">Utility Bill - latest 3 months (Electricity / Water / Internet or TV / landline / broadband bill)</option>
                                            <option value="Labour Contract">Labour contract (pages with Name, nationality, Passport numbers)</option>
                                        </select> </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <img id="myImg1" src="#" alt="your image" style="width:25%" onerror="this.style.display='none'"/>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <img id="myImg2" src="#" alt="your image" style="width:25%" onerror="this.style.display='none'"/>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <img id="myImg3" src="#" alt="your image" style="width:25%" onerror="this.style.display='none'"/>
                                </div>
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary me-1"
                                    onclick="SavingActivationLead('{{ route('submit.verification') }}', 'MyRoleForm','{{ route('home') }}')">Submit For Verification</button>
                            {{-- </div> --}}
                            {{-- <div class="col-12"> --}}
                                <button type="submit" class="btn btn-primary me-1"
